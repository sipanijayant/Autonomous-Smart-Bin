...
DATA_URL='http://download.tensorflow.org/models/inception_v1_2016_08_28.tar.gz'-faster
DATA_URL='http://download.tensorflow.org/models/inception_v2_2016_08_28.tar.gz'-much much faster
DATA_URL='http://download.tensorflow.org/models/inception_v4_2016_09_09.tar.gz'
DATA_URL='http://download.tensorflow.org/models/resnet_v2_101_2017_04_14.tar.gz'"""
...
def main(_):
  ...
  #frozen = tf.graph_util.convert_variables_to_constants(sess, sess.graph_def,["import/final_result"])
  #graph_io.write_graph(frozen, './','C:/Users/sreya/tensorflow/tensorflow/examples/image_retraining/retrained_graphs.pb' , as_text=False)
